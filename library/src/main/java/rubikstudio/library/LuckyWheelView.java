...
public class LuckyWheelView extends RelativeLayout implements PielView.PieRotateListener {
    ...
    public void rotateStart(boolean isRunning) {
        if (mLuckyRoundItemSelectedListener != null) {
            mLuckyRoundItemSelectedListener.rotateStart(isRunning);
        }
    }
    ...
    private void init(Context ctx, AttributeSet attrs) {
        if (attrs != null) {
            ...
            mSecondaryTextSize = typedArray.getDimensionPixelSize(R.styleable.LuckyWheelView_lkwSecondaryTextSize, (int) LuckyWheelUtils.convertDpToPixel(14f, getContext()));
            ...
            mBorderColor = typedArray.getColor(R.styleable.LuckyWheelView_lkwEdgeColor, 0xff8E8E8E);
            typedArray.recycle();
        }
    ...
    public void setWhileList(List<Integer> integers){
        pielView.setWhileList(integers);
    }
    ...
    public boolean isRunning(){
        return pielView.isRunning();
    }

    public void stopLuckWeel(){
        pielView.stopLuckyWheel();
    }
}
